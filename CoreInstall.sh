...
WinRDP(){
  ...
  # Suntikan untuk Memaksa Bahasa Inggris (US)
  echo -ne "reg\0040add\0040\0042HKCU\0134Control\0040Panel\0134Desktop\0042\0040\0057v\0040PreferredUILanguages\0040\0057t\0040REG\0137SZ\0040\0057d\0040en\0055US\0040\0057f\r\n" >>'/tmp/boot/net.tmp';
  # Suntikan untuk Memaksa Zona Waktu Jakarta (WIB)
  echo -ne "tzutil\0040\0057s\0040\0042SE\0040Asia\0040Standard\0040Time\0042\r\n" >>'/tmp/boot/net.tmp';
}
